...
# Setup prompt
#
RUN echo 'export PS1="[Demo Client for Passmeister Apple Wallet and Google Wallet API] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Demo Client for Passmeister Apple Wallet and Google Wallet API] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Demo Client for Passmeister Apple Wallet and Google Wallet API$(tput sgr0).\n\
\n\
